  ...
  return (
    <div className='fixed w-full h-20 shadow-xl z-[100]'>
      ...
      <div className='fixed left-0 top-0 w-full h-screen bg-black/70'>
        <div className='fixed left-0 top-0 w-[75%] sm:w-[60%] md:w-[45%] h-screen bg-[#ffffff] p-10 ease-in duration-500'>
          <div>
          ...
          <div className='py-4 flex-col'>
            ...
            <div className='pt-40'>
              <p className='uppercase tracking-widest text-[#31bab1]'>Connect</p>
