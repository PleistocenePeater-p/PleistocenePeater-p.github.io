    ...
    <div className='w-full md:h-screen p-2 flex items-center py-16'>
        <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
            <div className='col-span-2'>
                ...
                <p className='py-2 text-gray-600'>Raised on sci-fi, I grew up with an enthusiasm for technology, and later an admiration for computer science. My recent role as the Business Development Director for a local Chamber of Commerce affirmed the value of "automating the boring stuff". It was there I found the crucial link between my lifelong passion for impressive engineering feats and real-world business challenges I confronted with business owners.</p>
